            ...
            <div class="row">
                ...
                <form action="../GuestController" method="post">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <div class="qty-buttons mb-3 version_2">
                                <input type="button" value="+" class="qtyplus" name="guestQuantity">
                                <input type="text" name="guestQuantity" id="guestQuantity" value=""
                                    class="qty form-control" placeholder="Guest Quantity">
                                <input type="button" value="-" class="qtyminus" name="guestQuantity">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-8">
                            <div class="qty-buttons mb-3 version_2">
                                <input type="button" value="+" class="qtyplus" name="durationOfStay">
                                <input type="text" name="durationOfStay" id="durationOfStay" value=""
                                    class="qty form-control" placeholder="Nights">
                                <input type="button" value="-" class="qtyminus" name="durationOfStay">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-8">
                                <div class="qty-buttons mb-3 version_2">
                                    <input type="button" value="+" class="qtyplus" name="totalAdult">
                                    <input type="text" name="totalAdult" id="totalAdult" value=""
                                        class="qty form-control" placeholder="Adults">
                                    <input type="button" value="-" class="qtyminus" name="totalAdult">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-8">
                                <div class="mb-3 qty-buttons mb-3 version_2">
                                    <input type="button" value="+" class="qtyplus" name="totalKids">
                                    <input type="text" name="totalKids" id="totalKids" value="" class="qty form-control"
                                        placeholder="Childs">
                                    <input type="button" value="-" class="qtyminus" name="totalKids">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-8">
                                <div class="qty-buttons mb-3 version_2">
                                    ...
                                    <input type="text" name="totalRoom" id="totalRoom" value="" class="qty form-control"
                                        placeholder="Total Room">
                                    <input type="button" value="-" class="qtyminus" name="totalRoom">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-5">
                        <div class="col text-center">
                            <a href="guestRoomReservation.jsp" class="btn btn-dark btn-lg"
                                style="border-radius: 3px 3px 3px 3px; height: auto; width:150px">Submit</a>
                        </div>
                    </div>

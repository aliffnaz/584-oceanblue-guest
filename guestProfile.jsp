		...
		<div class="sidebar-navigation">
			<nav>
				...
				<ul class="level-1">
					...
					<li><a href="guestProfile.jsp"><i
							class="bi bi-person-square" style="font-size: 25px;"></i>
							&nbsp;Profile</a></li>
					<li><a href="guestViewRoom.jsp"><i class="bi bi-door-open"
							style="font-size: 25px;"></i> &nbsp;Our Rooms</a></li>
					<li><a href="guestMakeRoomReservation.jsp"><i
							class="bi bi-plus" style="font-size: 25px;"></i> &nbsp;Make
							Reservation</a></li>
					<li><a href="guestRoomReservation.jsp"><i
							class="bi bi-receipt-cutoff" style="font-size: 25px;"></i>
							&nbsp;Records</a></li>
					<li class="mt-5"><a href="guestLogin.jsp"
				...
				<div class="col-md card card-body py-5">
					...
					<div class="row m-5">
						<div class="col-2 text-center">
							<a
								href="GuestController?action=guestHome&guestICNumber=<c:out value="${guest.guestICNumber} "/>">
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestAddress" id="" class="form-control"
								value="<c:out value="${guest.guestAddress}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestGender" id="" class="form-control"
								value="<c:out value="${guest.guestGender}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestRace" id="" class="form-control"
								value="<c:out value="${guest.guestRace}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="text" name="guestReligion" id=""
								class="form-control"
								value="<c:out value="${guest.guestReligion}"/>" disabled>
					...
					<div class="row m-3">
						...
						<div class="col-8">
							<input type="password" name="guestPassword" id=""
								class="form-control"
								value="<c:out value="${guest.guestPassword}"/>" disabled>
						</div>
					</div>
					...
					<div class="row m-5">
						...
						<div class="col">
							<a
								href="GuestController?action=guestUpdateV&guestICNumber=<c:out value="${guest.guestICNumber}"/>"
